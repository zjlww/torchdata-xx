...
#define UCD_PROPERTY_WHITE_SPACE \
    0x0000000000000001ull /**< @brief White_Space */
#define UCD_PROPERTY_BIDI_CONTROL \
    0x0000000000000002ull /**< @brief Bidi_Control */
#define UCD_PROPERTY_JOIN_CONTROL \
    0x0000000000000004ull                         /**< @brief Join_Control */
#define UCD_PROPERTY_DASH 0x0000000000000008ull   /**< @brief Dash */
#define UCD_PROPERTY_HYPHEN 0x0000000000000010ull /**< @brief Hyphen */
#define UCD_PROPERTY_QUOTATION_MARK \
    0x0000000000000020ull /**< @brief Quotation_Mark */
#define UCD_PROPERTY_TERMINAL_PUNCTUATION \
    0x0000000000000040ull /**< @brief Terminal_Punctuation */
...
#define UCD_PROPERTY_ASCII_HEX_DIGIT \
    0x0000000000000200ull /**< @brief ASCII_Hex_Digit */
#define UCD_PROPERTY_OTHER_ALPHABETIC \
    0x0000000000000400ull /**< @brief Other_Alphabetic */
#define UCD_PROPERTY_IDEOGRAPHIC \
    0x0000000000000800ull                            /**< @brief Ideographic */
...
#define UCD_PROPERTY_OTHER_LOWERCASE \
    0x0000000000004000ull /**< @brief Other_Lowercase */
#define UCD_PROPERTY_OTHER_UPPERCASE \
    0x0000000000008000ull /**< @brief Other_Uppercase */
#define UCD_PROPERTY_NONCHARACTER_CODE_POINT \
    0x0000000000010000ull /**< @brief Noncharacter_Code_Point */
#define UCD_PROPERTY_OTHER_GRAPHEME_EXTEND \
    0x0000000000020000ull /**< @brief Other_Grapheme_Extend */
#define UCD_PROPERTY_IDS_BINARY_OPERATOR \
    0x0000000000040000ull /**< @brief IDS_Binary_Operator */
#define UCD_PROPERTY_IDS_TRINARY_OPERATOR \
    0x0000000000080000ull /**< @brief IDS_Trinary_Operator */
#define UCD_PROPERTY_RADICAL 0x0000000000100000ull /**< @brief Radical */
#define UCD_PROPERTY_UNIFIED_IDEOGRAPH \
    0x0000000000200000ull /**< @brief Unified_Ideograph */
#define UCD_PROPERTY_OTHER_DEFAULT_IGNORABLE_CODE_POINT \
    0x0000000000400000ull /**< @brief Other_Default_Ignorable_Code_Point */
#define UCD_PROPERTY_DEPRECATED 0x0000000000800000ull /**< @brief Deprecated \
                                                       */
#define UCD_PROPERTY_SOFT_DOTTED \
    0x0000000001000000ull /**< @brief Soft_Dotted */
#define UCD_PROPERTY_LOGICAL_ORDER_EXCEPTION \
    0x0000000002000000ull /**< @brief Logical_Order_Exception */
#define UCD_PROPERTY_OTHER_ID_START \
    0x0000000004000000ull /**< @brief Other_ID_Start */
#define UCD_PROPERTY_OTHER_ID_CONTINUE \
    0x0000000008000000ull /**< @brief Other_ID_Continue */
#define UCD_PROPERTY_SENTENCE_TERMINAL \
    0x0000000010000000ull /**< @brief Sentence_Terminal */
#define UCD_PROPERTY_VARIATION_SELECTOR \
    0x0000000020000000ull /**< @brief Variation_Selector */
#define UCD_PROPERTY_PATTERN_WHITE_SPACE \
    0x0000000040000000ull /**< @brief Pattern_White_Space */
#define UCD_PROPERTY_PATTERN_SYNTAX \
    0x0000000080000000ull /**< @brief Pattern_Syntax */
#define UCD_PROPERTY_PREPENDED_CONCATENATION_MARK \
    0x0000000100000000ull /**< @brief Prepended_Concatenation_Mark */
#define UCD_PROPERTY_EMOJI 0x0000000200000000ull /**< @brief Emoji */
#define UCD_PROPERTY_EMOJI_PRESENTATION \
    0x0000000400000000ull /**< @brief Emoji_Presentation */
#define UCD_PROPERTY_EMOJI_MODIFIER \
    0x0000000800000000ull /**< @brief Emoji_Modifier */
#define UCD_PROPERTY_EMOJI_MODIFIER_BASE \
    0x0000001000000000ull /**< @brief Emoji_Modifier_Base */
#define UCD_PROPERTY_REGIONAL_INDICATOR \
    0x0000002000000000ull /**< @brief Regional_Indicator */
#define UCD_PROPERTY_EMOJI_COMPONENT \
    0x0000004000000000ull /**< @brief Emoji_Component */
#define UCD_PROPERTY_EXTENDED_PICTOGRAPHIC \
    0x0000008000000000ull /**< @brief Extended_Pictographic */

// eSpeak NG extended properties:
#define ESPEAKNG_PROPERTY_INVERTED_TERMINAL_PUNCTUATION \
    0x0010000000000000ull /**< @brief Inverted_Terminal_Punctuation */
#define ESPEAKNG_PROPERTY_PUNCTUATION_IN_WORD \
    0x0020000000000000ull /**< @brief Punctuation_In_Word */
#define ESPEAKNG_PROPERTY_OPTIONAL_SPACE_AFTER \
    0x0040000000000000ull /**< @brief Optional_Space_After */
#define ESPEAKNG_PROPERTY_EXTENDED_DASH \
    0x0080000000000000ull /**< @brief Extended_Dash */
#define ESPEAKNG_PROPERTY_PARAGRAPH_SEPARATOR \
    0x0100000000000000ull /**< @brief Paragraph_Separator */
#define ESPEAKNG_PROPERTY_ELLIPSIS 0x0200000000000000ull /**< @brief Ellipsis \
                                                          */
#define ESPEAKNG_PROPERTY_SEMI_COLON \
    0x0400000000000000ull                             /**< @brief Semi_Colon */
...
#define ESPEAKNG_PROPERTY_EXCLAMATION_MARK \
    0x2000000000000000ull /**< @brief Exclamation_Mark */
#define ESPEAKNG_PROPERTY_QUESTION_MARK \
    0x4000000000000000ull /**< @brief Question_Mark */
#define ESPEAKNG_PROPERTY_FULL_STOP \
    0x8000000000000000ull /**< @brief Full_Stop */
...
// {
// 	return
// (category_group)ucd_get_category_group_for_category((ucd_category)c);
// }
...
enum script {
    ...
    Cyrs = UCD_SCRIPT_Cyrs, /**< @brief Cyrillic (Old Church Slavonic variant)
                               Script */
    ...
    Jpan = UCD_SCRIPT_Jpan, /**< @brief Japanese (Han + Hiragana + Katakana)
                               Scripts */
...
enum {
    ...
    Terminal_Punctuation =
        UCD_PROPERTY_TERMINAL_PUNCTUATION, /**< @brief Terminal_Punctuation */
    Other_Math = UCD_PROPERTY_OTHER_MATH,  /**< @brief Other_Math */
    Hex_Digit = UCD_PROPERTY_HEX_DIGIT,    /**< @brief Hex_Digit */
    ASCII_Hex_Digit =
        UCD_PROPERTY_ASCII_HEX_DIGIT, /**< @brief ASCII_Hex_Digit */
    Other_Alphabetic =
        UCD_PROPERTY_OTHER_ALPHABETIC,      /**< @brief Other_Alphabetic */
    ...
    Other_Lowercase =
        UCD_PROPERTY_OTHER_LOWERCASE, /**< @brief Other_Lowercase */
    Other_Uppercase =
        UCD_PROPERTY_OTHER_UPPERCASE, /**< @brief Other_Uppercase */
    Noncharacter_Code_Point =
        UCD_PROPERTY_NONCHARACTER_CODE_POINT, /**< @brief
                                                 Noncharacter_Code_Point */
    Other_Grapheme_Extend =
        UCD_PROPERTY_OTHER_GRAPHEME_EXTEND, /**< @brief Other_Grapheme_Extend */
    IDS_Binary_Operator =
        UCD_PROPERTY_IDS_BINARY_OPERATOR, /**< @brief IDS_Binary_Operator */
    IDS_Trinary_Operator =
        UCD_PROPERTY_IDS_TRINARY_OPERATOR, /**< @brief IDS_Trinary_Operator */
    Radical = UCD_PROPERTY_RADICAL,        /**< @brief Radical */
    Unified_Ideograph =
        UCD_PROPERTY_UNIFIED_IDEOGRAPH, /**< @brief Unified_Ideograph */
    Other_Default_Ignorable_Code_Point =
        UCD_PROPERTY_OTHER_DEFAULT_IGNORABLE_CODE_POINT, /**< @brief
                                                            Other_Default_Ignorable_Code_Point
                                                          */
    Deprecated = UCD_PROPERTY_DEPRECATED,   /**< @brief Deprecated */
    Soft_Dotted = UCD_PROPERTY_SOFT_DOTTED, /**< @brief Soft_Dotted */
    Logical_Order_Exception =
        UCD_PROPERTY_LOGICAL_ORDER_EXCEPTION,     /**< @brief
                                                     Logical_Order_Exception */
    Other_ID_Start = UCD_PROPERTY_OTHER_ID_START, /**< @brief Other_ID_Start */
    Other_ID_Continue =
        UCD_PROPERTY_OTHER_ID_CONTINUE, /**< @brief Other_ID_Continue */
    Sentence_Terminal =
        UCD_PROPERTY_SENTENCE_TERMINAL, /**< @brief Sentence_Terminal */
    Variation_Selector =
        UCD_PROPERTY_VARIATION_SELECTOR, /**< @brief Variation_Selector */
    Pattern_White_Space =
        UCD_PROPERTY_PATTERN_WHITE_SPACE, /**< @brief Pattern_White_Space */
    Pattern_Syntax = UCD_PROPERTY_PATTERN_SYNTAX, /**< @brief Pattern_Syntax */
    Prepended_Concatenation_Mark =
        UCD_PROPERTY_PREPENDED_CONCATENATION_MARK, /**< @brief
                                                      Prepended_Concatenation_Mark
                                                    */
    Emoji = UCD_PROPERTY_EMOJI,                    /**< @brief Emoji */
    Emoji_Presentation =
        UCD_PROPERTY_EMOJI_PRESENTATION, /**< @brief Emoji_Presentation */
    Emoji_Modifier = UCD_PROPERTY_EMOJI_MODIFIER, /**< @brief Emoji_Modifier */
    Emoji_Modifier_Base =
        UCD_PROPERTY_EMOJI_MODIFIER_BASE, /**< @brief Emoji_Modifier_Base */
    Regional_Indicator =
        UCD_PROPERTY_REGIONAL_INDICATOR, /**< @brief Regional_Indicator */
    Emoji_Component =
        UCD_PROPERTY_EMOJI_COMPONENT, /**< @brief Emoji_Component */
    Extended_Pictographic =
        UCD_PROPERTY_EXTENDED_PICTOGRAPHIC, /**< @brief Extended_Pictographic */
};
 ...
 * @return  Non-zero if the codepoint is in the 'alnum' class, zero otherwise.
 */
inline int isalnum(codepoint_t c) { return ucd_isalnum(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'alpha' class, zero otherwise.
 */
inline int isalpha(codepoint_t c) { return ucd_isalpha(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'blank' class, zero otherwise.
 */
inline int isblank(codepoint_t c) { return ucd_isblank(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'cntrl' class, zero otherwise.
 */
inline int iscntrl(codepoint_t c) { return ucd_iscntrl(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'digit' class, zero otherwise.
 */
inline int isdigit(codepoint_t c) { return ucd_isdigit(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'graph' class, zero otherwise.
 */
inline int isgraph(codepoint_t c) { return ucd_isgraph(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'lower' class, zero otherwise.
 */
inline int islower(codepoint_t c) { return ucd_islower(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'print' class, zero otherwise.
 */
inline int isprint(codepoint_t c) { return ucd_isprint(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'punct' class, zero otherwise.
 */
inline int ispunct(codepoint_t c) { return ucd_ispunct(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'space' class, zero otherwise.
 */
inline int isspace(codepoint_t c) { return ucd_isspace(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'upper' class, zero otherwise.
 */
inline int isupper(codepoint_t c) { return ucd_isupper(c); }
 ...
 * @return  Non-zero if the codepoint is in the 'xdigit' class, zero otherwise.
 */
inline int isxdigit(codepoint_t c) { return ucd_isxdigit(c); }
 ...
 *          this codepoint if there is no upper-case codepoint.
 */
inline codepoint_t toupper(codepoint_t c) { return ucd_toupper(c); }
 ...
 *          this codepoint if there is no upper-case codepoint.
 */
inline codepoint_t tolower(codepoint_t c) { return ucd_tolower(c); }
 ...
 *          this codepoint if there is no upper-case codepoint.
 */
inline codepoint_t totitle(codepoint_t c) { return ucd_totitle(c); }
}  // namespace ucd
#endif
